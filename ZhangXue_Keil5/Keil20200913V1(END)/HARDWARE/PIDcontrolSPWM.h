...
#define OutputOC2State_Enable			TIM8->CCER |= 0x0010
#define OutputOC2State_Disable		TIM8->CCER &= 0xffef
#define OutputOC2NState_Enable		TIM8->CCER |= 0x0040
#define OutputOC2NState_Disable		TIM8->CCER &= 0xffbf
#define OutputOC3State_Enable			TIM8->CCER |= 0x0100
#define OutputOC3State_Disable		TIM8->CCER &= 0xfeff
#define OutputOC3NState_Enable		TIM8->CCER |= 0x0400
#define OutputOC3NState_Disable		TIM8->CCER &= 0xfbff
...
//#define OutputOC3NState_Disable		TIM8->CCER &= (0xfffb <<8)//移位后可能是补零，不小心修改了其他位
